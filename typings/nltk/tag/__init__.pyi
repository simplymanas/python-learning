...
def _get_tagger(lang: Optional[Any] = ...):
    ...

def _pos_tag(tokens, tagset: Optional[Any] = ..., tagger: Optional[Any] = ..., lang: Optional[Any] = ...):
    ...

def pos_tag(tokens, tagset: Optional[Any] = ..., lang=...):
    """
...
def pos_tag_sents(sentences, tagset: Optional[Any] = ..., lang=...):
    """
