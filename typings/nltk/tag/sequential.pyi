...
class SequentialBackoffTagger(TaggerI):
    ...
    """
    def __init__(self, backoff: Optional[Any] = ...):
        ...
...
class ContextTagger(SequentialBackoffTagger):
    ...
    """
    def __init__(self, context_to_tag, backoff: Optional[Any] = ...):
        """
    ...
    def _train(self, tagged_corpus, cutoff=..., verbose: bool = ...):
        """
...
class NgramTagger(ContextTagger):
    ...
    """
    json_tag = ...
    def __init__(self, n, train: Optional[Any] = ..., model: Optional[Any] = ..., backoff: Optional[Any] = ..., cutoff=..., verbose: bool = ...):
        ...
...
class UnigramTagger(NgramTagger):
    ...
    """
    json_tag = ...
    def __init__(self, train: Optional[Any] = ..., model: Optional[Any] = ..., backoff: Optional[Any] = ..., cutoff=..., verbose: bool = ...):
        ...
...
class AffixTagger(ContextTagger):
    ...
    """
    json_tag = ...
    def __init__(self, train: Optional[Any] = ..., model: Optional[Any] = ..., affix_length=..., min_stem_length=..., backoff: Optional[Any] = ..., cutoff=..., verbose: bool = ...):
        ...
...
class RegexpTagger(SequentialBackoffTagger):
    ...
    """
    json_tag = ...
    def __init__(self, regexps, backoff: Optional[Any] = ...):
        """
        """
        ...
...
class ClassifierBasedTagger(SequentialBackoffTagger, FeaturesetTaggerI):
    ...
    """
    def __init__(self, feature_detector: Optional[Any] = ..., train: Optional[Any] = ..., classifier_builder=..., classifier: Optional[Any] = ..., backoff: Optional[Any] = ..., cutoff_prob: Optional[Any] = ..., verbose: bool = ...):
        ...
