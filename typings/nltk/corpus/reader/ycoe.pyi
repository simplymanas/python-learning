...
class YCOECorpusReader(CorpusReader):
    ...
    def documents(self, fileids: Optional[Any] = ...):
        """
    ...
    def fileids(self, documents: Optional[Any] = ...):
        """
    ...
    def words(self, documents: Optional[Any] = ...):
        ...
    
    def sents(self, documents: Optional[Any] = ...):
        ...
    
    def paras(self, documents: Optional[Any] = ...):
        ...
    
    def tagged_words(self, documents: Optional[Any] = ...):
        ...
    
    def tagged_sents(self, documents: Optional[Any] = ...):
        ...
    
    def tagged_paras(self, documents: Optional[Any] = ...):
        ...
    
    def parsed_sents(self, documents: Optional[Any] = ...):
        ...
...
class YCOETaggedCorpusReader(TaggedCorpusReader):
    def __init__(self, root, items, encoding=...):
        ...
