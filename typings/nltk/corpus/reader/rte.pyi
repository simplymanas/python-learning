...
class RTEPair(object):
    ...
    """
    def __init__(self, pair, challenge: Optional[Any] = ..., id: Optional[Any] = ..., text: Optional[Any] = ..., hyp: Optional[Any] = ..., value: Optional[Any] = ..., task: Optional[Any] = ..., length: Optional[Any] = ...):
        """
